...
<body>
    <form id="form1" runat="server">
        ...
        <asp:DropDownList ID="drpTech" runat="server" CssClass="auto-style23" AppendDataBoundItems="true" OnSelectedIndexChanged="drpTech_SelectedIndexChanged">
        ...
        <asp:TextBox ID="txtMInit" runat="server" CssClass="auto-style17"></asp:TextBox>
